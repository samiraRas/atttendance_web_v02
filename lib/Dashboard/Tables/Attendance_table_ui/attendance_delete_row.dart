...
class AttendanceDeleteView extends StatefulWidget {
  String token;
  String id;
  Function refresh;
  AttendanceDeleteView(
      ...
      : super(key: key);
  @override
  _AttendanceDeleteView createState() => _AttendanceDeleteView();
}

class _AttendanceDeleteView extends State<AttendanceDeleteView> {
